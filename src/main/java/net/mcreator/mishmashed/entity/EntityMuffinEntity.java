...
public class EntityMuffinEntity extends TamableAnimal {
	...
	public EntityMuffinEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		this(MishmashedModEntities.ENTITY_MUFFIN, world);
	}

	public EntityMuffinEntity(EntityType<EntityMuffinEntity> type, Level world) {
		super(type, world);
		xpReward = 3;
		setNoAi(false);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(MishmashedModItems.MUFFIN));
	}

	@Override
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("mishmashed:jumpscream"));
	}

	@Override
	public void playStepSound(BlockPos pos, BlockState blockIn) {
		this.playSound(ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("mishmashed:muffinpew")), 0.15f, 1);
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		EntityMuffinEntity retval = MishmashedModEntities.ENTITY_MUFFIN.create(serverWorld);
