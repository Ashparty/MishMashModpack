...
public class WildMuffinEntity extends TamableAnimal {
	...
	public WildMuffinEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		this(MishmashedModEntities.WILD_MUFFIN, world);
	}

	public WildMuffinEntity(EntityType<WildMuffinEntity> type, Level world) {
		super(type, world);
		xpReward = 1;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		WildMuffinRightClickedOnEntityProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}

	@Override
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		WildMuffinEntity retval = MishmashedModEntities.WILD_MUFFIN.create(serverWorld);
